...
class Base(object):
    """
    Base methods for data objects in Lightning.
...
class Data(Base):
    """
    Generic base class for primary data types in Lightning.

    All data types are backed by an array-like container for many homogeneous arrays.
